...
while True:
    try:
        salario = float(input("Ingrese su salario mensual , por favor: "))
        
        if salario <=0 and salario <= 1900.000:
            print("\n\nEL SALARIO QUE INGRESO NO ES VALIDO PARA IMPUESTO\n\n")
...
if salario >0 and salario < 2000000:
    print("\n\nAPLICA UN IMPUESTO DE 0%\n\n ")
    
elif salario > 2000000 and  salario <= 5000000:
    print("\n\nAPLICA UN IMPUESTO DEL 10%\n\n ")
